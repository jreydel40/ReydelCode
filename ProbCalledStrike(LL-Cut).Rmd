...
quad(query[1200,]$ay, query[1200,]$vy0, query[1200,]$y0)
query$platetime = 0
...
```{r}
save(logregsl, file = "logreg_RR_SL.RData")
...
```{r}
logreg_preds1 <- predict(logregsl, test, type = "response", re.form = NA) #StrikePerc
